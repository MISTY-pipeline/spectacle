...
def test_line_stats():
    ...
    assert_quantity_allclose(line_stats['ew'][0], 0.05447731 * u.AA)
    ...
    assert_quantity_allclose(line_stats['ew'][1], 0.05448273 * u.AA)
...
def test_region_stats():
    ...
    assert_quantity_allclose(region_stats['ew'], 0.08129795 * u.AA)

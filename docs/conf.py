...
# -*- coding: utf-8 -*-
#
# Spectacle documentation build configuration file, created by
...
project = 'Spectacle'
copyright = '2017, Nicholas Earl, Molly Peeples'
...
htmlhelp_basename = 'Spectacledoc'
...
latex_documents = [
    (master_doc, 'Spectacle.tex', 'Spectacle Documentation',
     'Nicholas Earl, Molly Peeples', 'manual'),
]
